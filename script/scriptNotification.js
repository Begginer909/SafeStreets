...
function openModal(latitude, longitude, street, crimeType, description) {
...
document.addEventListener('click', async (e) => {
    if (e.target.classList.contains('btn-view')) {
        ...
        openModal(data.latitude, data.longitude, data.street, data.crimeType, data.description);
