...
const formData = {
    ...
    birthdate: `${document.getElementById('year').value}-${String(document.getElementById('month').value).padStart(2, '0')}-${String(document.getElementById('day').value).padStart(2, '0')}`,
