                ...
                <nav class="navbar" id="navbar" >
                        ...
                        <div class="collapse collapse-horizontal bg-primary mt-5 " id="collapseWidthExample">
                                <ul class="navbar-nav fs-4 mx-3">
                                    <li class="nav-item">
                                        <a class="nav-link text-light" name="Accounts" aria-current="true" href="">Accounts</a>
                                    </li>
                                    <li class="nav-item">
            ...
            <div class="col-11" id="content">
                            ...
                            <a href="#" class="text-decoration-none">
                                <div class="card text-center shadow-sm" style="height: 200px;">
                                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                                        ...
                                        <p class="card-text">View user and staff accounts.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="col-12 mt-3">
                        <div class="sizeCanvas">
                            <canvas class="ms-lg-5" id="myChart"></canvas>
                        </div>
                    </div>
